...
import com.ejb.NewSessionBeanRemote;
...
public class AjaxCometServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        String s_check=req.getParameter("");
        
         //EJB Contnets
         String result=newSessionBean.businessMethod(name);

        if ("login".equals(action)) {
            String cMessage = BEGIN_SCRIPT_TAG + toJsonp("System Message", name + " has joined."+ result) + END_SCRIPT_TAG;
            notify(cMessage);
